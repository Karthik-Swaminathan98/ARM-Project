...
#define FFT_SIZE 512        // FFT size (change as needed: 8, 16, 32, 64, 128, 256, 512, 1024)
...
int main(void)
{
	...
	float32_t input[N * 2]; // Interleaved input (real + imag)
	float32_t output[N]; // Output (complex)
